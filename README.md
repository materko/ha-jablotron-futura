...
- Sensors for temperatures, humidity, power, airflow, setpoints, timers, and UI controllers (address/settings/CO₂/temperature/humi for up to 4 + total count), ALFA controllers (address/settings/CO₂/temperature/humi/NTC temperature for up to 8 units + total count) and sensors (address/settings/CO₂/temperature/humi for up to 8 + total count).
